...
; Workspacer style hiding seems to be faster
Run, komorebic window-hiding-behaviour hide, , Hide
...
Run, komorebic.exe workspace-padding 0 0 2, , Hide
Run, komorebic.exe container-padding 0 0 2, , Hide
Run, komorebic.exe workspace-padding 0 1 2, , Hide
Run, komorebic.exe container-padding 0 1 2, , Hide
Run, komorebic.exe workspace-padding 0 2 2, , Hide
Run, komorebic.exe container-padding 0 2 2, , Hide
Run, komorebic.exe workspace-padding 0 3 2, , Hide
Run, komorebic.exe container-padding 0 3 2, , Hide
Run, komorebic.exe workspace-padding 0 4 2, , Hide
Run, komorebic.exe container-padding 0 4 2, , Hide
Run, komorebic.exe workspace-padding 0 5 2, , Hide
Run, komorebic.exe container-padding 0 5 2, , Hide
Run, komorebic.exe workspace-padding 1 0 2, , Hide
Run, komorebic.exe container-padding 1 0 2, , Hide
Run, komorebic.exe workspace-padding 1 1 2, , Hide
Run, komorebic.exe container-padding 1 1 2, , Hide
Run, komorebic.exe workspace-padding 1 2 2, , Hide
Run, komorebic.exe container-padding 1 2 2, , Hide
Run, komorebic.exe workspace-padding 1 3 2, , Hide
Run, komorebic.exe container-padding 1 3 2, , Hide
Run, komorebic.exe workspace-padding 1 4 2, , Hide
Run, komorebic.exe container-padding 1 4 2, , Hide
Run, komorebic.exe workspace-padding 1 5 2, , Hide
Run, komorebic.exe container-padding 1 5 2, , Hide
...
; Always float DevHub, matching on executable name
Run, komorebic.exe float-rule exe DevHub.exe, , Hide
; Always float RepoZ, matching on executable name
...
Run, komorebic.exe identify-tray-application exe zotero.exe, , Hide
